...
ClientUtils : MinecraftInstance() {
    ...
    fun setTitle() {
        Display.setTitle("${LiquidBounce.CLIENT_NAME} ${LiquidBounce.CLIENT_VERSION} (${LiquidBounce.MINECRAFT_VERSION}-${LiquidBounce.CLIENT_COMMID_ID}/${LiquidBounce.CLIENT_BRANCH})")
    }
    fun setTitle(stats:String) {
        Display.setTitle("${LiquidBounce.CLIENT_NAME} ${LiquidBounce.CLIENT_VERSION} (${LiquidBounce.MINECRAFT_VERSION}-${LiquidBounce.CLIENT_COMMID_ID}/${LiquidBounce.CLIENT_BRANCH})" + stats)
    }
