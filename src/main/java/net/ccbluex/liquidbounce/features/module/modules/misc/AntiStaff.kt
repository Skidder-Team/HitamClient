...
class AntiStaff : Module() {
    ...
    val server  = ListValue("Server", arrayOf("BlocksMC","Jartex","Pika","Minebox","Minemora","Zonecraft","Hycraft","Librecraft","LuckyNetwork","CavryNetwork"),"BlocksMC")
    ...
    private var luckynetStaff : String = "FacedApollo LyraMS ItzStormz BlazePxly Dapry Jiternos Cyclize SupraMen Isnic ChromaaXD Pulpen Nerozvox Atticuss Miichin _PedPed_ Pvpiify Prisoner Prqbu TerraDirtz Aeterna_ ArianShev CreEzte E4_Exist Enter_Wisely GeraldiNP ARVIN1308 BukanNezon _Rzz rajaopak DaozaBoy GazorYT JoseMarcellio KimRokSoo Xylanneal FayBoy ZenthicMC Afif87123 DaozaBoy xXAyamBetutuXx Valseven Rynqu RefkinZ mfik Dindin Ghifary Kaaje sepensins MrRanZler lanserz WhoIsRihun"
    private var cavrynetStaff : String = "Cavry Necrovert Lievert Dapry JektDV Nafry"
    ...
    fun onWorld(e: WorldEvent) {
        when (server.get().lowercase()) {
            ...
            "luckynetwork" -> {
                staffs = luckynetStaff
            }

            "cavrynetwork" -> {
                staffs = cavrynetStaff
            }
